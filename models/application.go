...
type Application struct {
	Id   int64  `orm:"auto"`
	Name string `orm:"size(128);unique" valid:"Required"`
	IP   string `orm:"size(128)" valid:"Required"`
	Token   string `orm:"size(128)" valid:"Required"`
}
...
func GetCountAllApplication() (count int64, err error){
	o := orm.NewOrm()
...
func DeleteApplication(id int64) (err error) {
	...
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&Application{Id: id}); err == nil {
