...
//  BuildControllerTEMP operations for Environment
type BuildControllerTEMP struct {
	beego.Controller
}

// URLMapping ...
func (c *BuildControllerTEMP) URLMapping() {
...
// @router / [post]
func (c *BuildControllerTEMP) Post() {
...
// @router /:id [get]
func (c *BuildControllerTEMP) GetOne() {
...
// @Failure 403
// @router / [get]
func (c *BuildControllerTEMP) GetAll() {
...
// @router /:id [put]
func (c *BuildControllerTEMP) Put() {
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *BuildControllerTEMP) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.ParseInt(idStr, 0, 64)
